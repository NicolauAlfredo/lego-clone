            ...
            <div class="cart_bottoni-wrapper">
              <div class="cart_bottoni">
                <div class="qty-btn-minus">
                  <button class="qty-btn btn-minus" data-btn-minus type="button" data-id="${product.id}"></button>
                </div>

                <span class="qty-num">${product.quantity}</span>

                <div class="qty-btn-plus">
                  <button class="qty-btn btn-plus" data-btn-plus type="button" data-id="${product.id}"></button>
                </div>
              </div>
